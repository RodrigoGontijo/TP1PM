...
public class SmallVehicles implements ParkSpaceInterface {
    ...
    public double getPrice(int hours, int minutes ) {
        return (hours*Constants.SMALLVEHICLESPRICE + minutes*Constants.SMALLVEHICLESPRICE/60);
    }
    ...
    public String getVehicleCheckout(int exitHours, int exitMinutes){
        ...
        return Constants.SMALLVEHICLESCODE+";" + String.format("%02d", hours) + ":" + String.format("%02d", minutes) + ";" + String.format("%.2f", price) + "\n";
    }
